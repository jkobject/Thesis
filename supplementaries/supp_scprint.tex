...
\caption[Number of labels predicted by the model for each class.]{We use hierarchical classification for cell type, disease, assay, and ethnicity.}\label{tab:s13-predictions}\\
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\centering
ethnicity
\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
