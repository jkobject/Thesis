...
From these initial objectives, we envisioned several impacts. This Ph.D.~project will contribute to methodological breakthroughs by providing new tools and methods for applying neural networks to unstructured data such as \gls{scRNA-seq}, and to improve the state of the art in \gls{GRN} prediction.
