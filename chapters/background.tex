...
But life is everywhere, and cellular engineering has already helped us make better crops, create synthetic meat, and design fungi that remove pollution. When people think about nanorobots, they should think about engineered cells instead \cite{daviesSyntheticBiologyVery2018}. Finally, Richard Feynman famously said, "What I cannot create, I do not understand." Therefore, the modeling of the cell stands as a key milestone in cellular biology, and, indeed, one cannot fulfill the aforementioned promises without a correct cellular blueprint.
...
\begin{figure}[ht]
 ...
 \caption[Image of a cell]{Image of a cell. Artist representation of a small part of a eukaryotic cell from cryo-ET images. Adopted from \citet{cellimage}}
 \label{fig:thecell}
\end{figure}
