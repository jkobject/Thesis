...
Devant un jury composé de : %(indiquer le jury complet) 		
		\begin{center}
			\begin{tabular}{l@{\hskip 1cm}l@{\hskip 1cm}l}
				\textsc{Prénom NOM, HDR}  & Université de Ville &Rapportrice \\
				\textsc{Valentina Boeva, DR}  & Université de Y &Examinateur\\
				\textsc{Eran Segal, Pr}  &Université Paris Cité  &Examinatrice \\
