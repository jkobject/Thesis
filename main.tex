...
Devant un jury composé de : %(indiquer le jury complet) 		
		\begin{center}
			\begin{tabular}{l@{\hskip 1cm}l@{\hskip 1cm}l}
				\textsc{Charlotte Bunne, CR}  &EPFL &Rapportrice \\
				\textsc{Valentina Boeva, CR}  &ETH de Zurich &Rapportrice\\
				\textsc{Simona Cristea, CR}  &Harvard &Examinatrice \\
				\textsc{Thomas Walter, DR}  &INSERM &Membre du comité de suivi \\
				\textsc{Laurent Jacob, DR}  &CNRS &Membre du comité de suivi  \\
				\textsc{Laura CANTINI, CR}  &CNRS &Directrice de thèse \\
				\textsc{Gabriel Peyré, DR}  &CNRS &Directeur de thèse \\
			\end{tabular}\\[1cm]
		\end{center}
